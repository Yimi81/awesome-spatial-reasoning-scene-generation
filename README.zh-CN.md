...
| Title                                             | Year | Venue   | 摘要                                                     |
| ------------------------------------------------- | ---- | ------- | -------------------------------------------------------- |
| [Holistic 3D Scene Parsing and Reconstruction](https://arxiv.org/abs/1808.02201) | 2018 | ECCV    | 从单张 RGB 图像解析物体布局、CAD 几何以及功能/物理约束。 |
| [Total3DUnderstanding](https://arxiv.org/abs/2002.12212) | 2020 | CVPR    | 从单张室内图像联合估计房间布局、物体姿态和 mesh。        |
| [Panoptic 3D Scene Reconstruction](https://arxiv.org/abs/2111.02444) | 2021 | NeurIPS | 将几何重建、语义分割和实例分割统一到单视角 3D 场景重建中。 |
| [Holistic 3D Scene Understanding with Implicit Representation](https://arxiv.org/abs/2103.06422) | 2021 | CVPR    | 使用隐式场景表示优化物体形状、姿态和整体布局。           |
| [Learning 3D Object Shape and Layout without 3D Supervision](https://arxiv.org/abs/2206.07028) | 2022 | CVPR    | 不依赖 3D 标注，从 2D/多视角监督中学习物体形状和空间布局。 |
| [High-Fidelity Single-view Holistic Reconstruction](https://arxiv.org/abs/2207.08656) | 2022 | ECCV    | 用 instance-aligned implicit functions 重建房间背景和前景物体。 |
...
| [BUOL](https://arxiv.org/abs/2306.00965)          | 2023 | CVPR    | 将 2D 观测提升为 occupancy-aware 的 panoptic 3D 场景重建。 |
| [Grounded SAM](https://arxiv.org/abs/2401.14159)  | 2024 | arXiv   | 结合开放集检测与 SAM 分割，用于 promptable 物体分解。    |
...
| [VGGT](https://arxiv.org/abs/2503.11651)          | 2025 | CVPR    | 从单视角或多视角直接预测相机、深度、点图和点轨迹。       |
...
| [Deep Prior Assembly](https://arxiv.org/abs/2410.15971)                                                                                                                          | 2024 | NeurIPS  | 组装 foundation model 的 deep priors，实现零样本单图场景重建。 |
...
| [MIDI](https://arxiv.org/abs/2412.03558)                                                                                                                                         | 2025 | CVPR     | 将 image-to-3D diffusion 扩展到多实例，并用跨实例注意力保持空间关系。 |
| [REPARO](https://arxiv.org/abs/2405.18525)                                                                                                                                       | 2025 | ICCV     | 先重建组合式 3D 资产，再通过可微布局优化对齐场景。    |
| [Gen3DSR](https://arxiv.org/abs/2404.03421)                                                                                                                                      | 2025 | 3DV      | 将单视角场景重建拆分为整体场景线索和物体级细节重建。  |
| [DepR](https://arxiv.org/abs/2507.22825)                                                                                                                                         | 2025 | ICCV     | 用深度引导的实例级扩散重建并组合单视角 3D 场景。      |
| [3D-RE-GEN](https://arxiv.org/abs/2512.17459)                                                                                                                                    | 2025 | arXiv    | 从单图重建带纹理物体和背景，并通过相机恢复和 4-DoF 地面对齐保持空间合理性。 |
| [SceneGen](https://arxiv.org/abs/2508.15769)                                                                                                                                     | 2026 | 3DV      | 单次前向生成多个带纹理 3D 资产及其空间布局。           |
...
| [3D-FRONT](https://arxiv.org/abs/2011.09127)                                                                                                     | 2021 | ICCV     | 带布局、语义和高质量纹理 CAD 家具的大规模室内场景数据集。 |
...
| [SF3D](https://arxiv.org/abs/2408.00653)                                                                                                        | 2025 | CVPR     | 通过 UV 展开和光照解耦实现快速单图带纹理 mesh 重建。      |
| [Hunyuan3D 2.0](https://arxiv.org/abs/2501.12202)                                                                                               | 2025 | arXiv    | 扩展扩散模型生成高分辨率带纹理 3D 资产。                  |
